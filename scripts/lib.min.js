...
"use strict";$.fn.owlRemoveItem=function(e){var o=$(this).data("owl.carousel");o._items=$.map(o._items,function(o,t){if(t!==e)return o}),$(this).find(".owl-item").eq(e).remove()},$.fn.owlFilter=function(e,o){var t=this,l=$("<div>").css("display","none");switch(void 0===$(t).data("owl-clone")?($(t).find(".owl-item:not(.cloned)").clone().appendTo(l),$(t).data("owl-clone",l)):l=$(t).data("owl-clone"),t.trigger("replace.owl.carousel",["<div/>"]),e){case"*":l.children().each(function(){t.trigger("add.owl.carousel",[$(this).clone()])});break;default:l.find(e).each(function(){t.trigger("add.owl.carousel",[$(this).parent().clone()])})}t.owlRemoveItem(0),t.trigger("refresh.owl.carousel").trigger("to.owl.carousel",[0]),o&&o.call(this,t)};
